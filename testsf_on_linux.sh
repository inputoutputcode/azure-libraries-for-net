...
dotnet build src/ResourceManagement/ServiceFabric/Microsoft.Azure.Management.ServiceFabric.Fluent.csproj -f $netstd14
...
dotnet test Fluent.Tests.csproj -f $netcore20 --filter ClassName=Fluent.Tests.ServiceFabric
